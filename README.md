# Bitcoin Chart
En Vue.js-applikation som hämtar historiska priser för Bitcoin :dollar: :credit_card: från Coingecko API och visar dem på en linjediagram med hjälp av Chart.js.
